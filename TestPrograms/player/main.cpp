...
struct heals{
    ...
    heals(string healType): healType(healType), next(nullptr){}
};
...
class player{
    ...
    public:
        ...
        void addHeal(string healType){
            heals* healNode = new heals(healType);
            healNode->next = healHead;
            healHead = healNode;
            cout<<"added to heals"<<endl;
        }
