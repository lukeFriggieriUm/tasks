...
int main(){
    ...
    do{
        ...
        case 'g': 
            newItem = new Grocery();
            newItem->input(); // Method to accept user input for Grocery details
            break;
        case 'e': // Electronics
            newItem = new Electronics();
            newItem->input(); // Method to accept user input for Electronics details
            break;
        // Add other cases for Clothing, Book, Toy, etc.
        default:
