...
class Item {
    public:
        ...
        virtual ~Item noexcept = default; // This line must end with a semicolon
};
...
class Grocery : public Item {
    ...
    public:
        ...
        ~Grocery() noexcept override = default;
};
...
class Electronics : public Item {
    ...
    public:
        ...
        ~Electronics() noexcept override = default;
};
...
class Book : public Item {
    ...
    public:
        ...
        void setGenre(const string& g) { this->genre = g; }
