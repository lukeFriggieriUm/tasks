...
int main(){
    ...
    list.push_back(make_unique<Grocery>("Apple", "2025-12-31", 2.99));
    list.push_back(make_unique<Electronics>("Laptop", "2 years", 999.99));
    list.push_back(make_unique<Clothing>("T-shirt", "L", 19.99));
    list.push_back(make_unique<Book>("The Catcher in the Rye", "Fiction", 10.99));
    list.push_back(make_unique<Toys>("Lego Set", "1 year", 29.99));
